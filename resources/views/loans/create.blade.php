@extends("layouts.app")
@section("title", __("titles.add_loan"))
    ...
    <div class="container">
        ...
        <form action="{{ route('loan.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="user_id" id="user_id" class="form-control">
                    @foreach($employees as $employee)
                        <option @selected(old('user_id') == $employee->id)value="{{ $employee->id }}">{{ $employee->name }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control @error(" quantity") is-invalid @enderror" type="number" id="quantity" name="quantity" required value="{{ old("quantity") }}">
                @error('quantity')
